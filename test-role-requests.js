...
console.log(JSON.stringify({
  "requestedRole": "ingeniero",
  "justification": "Necesito permisos de ingeniero para gestionar el sistema"
}, null, 2));

console.log('\n2️⃣ VER SOLICITUDES PENDIENTES (Solo ingenieros)');
console.log('GET /api/v1/role-requests/pending');
console.log('Headers: Authorization: Bearer {ingeniero-token}');

console.log('\n3️⃣ VER MIS SOLICITUDES (Usuario autenticado)');
console.log('GET /api/v1/role-requests/my-requests');
console.log('Headers: Authorization: Bearer {token}');

console.log('\n4️⃣ APROBAR SOLICITUD (Solo ingenieros)');
console.log('PATCH /api/v1/role-requests/{requestId}/approve');
console.log('Headers: Authorization: Bearer {ingeniero-token}');

console.log('\n5️⃣ RECHAZAR SOLICITUD (Solo ingenieros)');
...
console.log('\n6️⃣ ESTADÍSTICAS (Solo ingenieros)');
...
console.log('- Ver pendientes: ingeniero, superadmin');
console.log('- Aprobar/Rechazar: ingeniero, superadmin');
console.log('- Ver estadísticas: ingeniero, superadmin');
...
console.log('4. Ingeniero ve solicitudes pendientes');
console.log('5. Ingeniero aprueba/rechaza solicitud');
