...
const ejemplos = {
  ...
  crearSolicitud: {
    ...
    body: {
      ...
      justification: 'Necesito permisos de ingeniero para gestionar el sistema de gestión vial. Tengo experiencia en administración de sistemas similares y soy responsable del área de tecnología.'
    }
  },
  ...
  // 3. VER SOLICITUDES PENDIENTES (INGENIERO)
  solicitudesPendientes: {
    metodo: 'GET',
    url: 'http://localhost:3001/api/v1/role-requests/pending',
    headers: {
      'Authorization': 'Bearer YOUR_INGENIERO_TOKEN_HERE'
    }
  },

  // 4. VER TODAS LAS SOLICITUDES (INGENIERO)
  todasLasSolicitudes: {
    metodo: 'GET',
    url: 'http://localhost:3001/api/v1/role-requests',
    headers: {
  ...
  // 7. RECHAZAR SOLICITUD (INGENIERO)
  rechazarSolicitud: {
    metodo: 'PATCH',
...
console.log('5. Con ingeniero token, ver solicitudes pendientes');
